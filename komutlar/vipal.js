...
exports.run = async(client, message, args) => {
   if(!message.member.roles.cache.has('818119975364853780')) return message.channel.send('Bu komutu kullanabilmek için gerekli yetkiye sahip değilsin : `İsGod`')
   ...
   .addField('Komutu Kullanan Yetkili', message.author)
    .setImage('https://media.discordapp.net/attachments/786344890123812874/815340658566234163/text_4.gif')   
