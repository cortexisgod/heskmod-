...
const mutelog = message.guild.channels.cache.find(c => c.id === '832269859265314826')//Mute log
const muterol = message.guild.roles.cache.find(r => r.id === '828404929387167744')//Muteli rolü
